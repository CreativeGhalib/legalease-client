            ...
            return (
              <button
                ...
                className={`rounded-lg border px-1 py-2 text-center text-xs font-semibold transition ${
                  active ? 'border-[#1b3a6b] bg-[#1b3a6b] dark:bg-[#d4a843] dark:text-[#0c1827] text-white' : 'border-slate-300 dark:border-[#1c3050] text-slate-600 dark:text-[#a8bbcc] hover:bg-slate-100 dark:hover:bg-[#162236]'
                }`}
              >
              ...
              {slotsQuery.data.slots.map((slot) => (
                <button
                  ...
                  className={`min-h-10 rounded-lg border px-3 text-sm font-semibold transition ${
                    selectedSlot === slot
                      ? 'border-[#1b3a6b] bg-[#1b3a6b] dark:bg-[#d4a843] dark:text-[#0c1827] text-white'
