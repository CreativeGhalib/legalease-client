...
export default function LawyerDetailsPage() {
  ...
  const location = useLocation(); const navigate = useNavigate(); const [modalOpen, setModalOpen] = useState(false)
  const lawyerQuery = useQuery({ queryKey: ['public-lawyer', lawyerId], queryFn: () => getPublicLawyer(lawyerId) })
  const role = user?.role?.trim().toLowerCase()
  const myRequests = useQuery({ queryKey: ['hiring-requests', 'mine'], queryFn: getMyHiringRequests, enabled: role === 'user' })
