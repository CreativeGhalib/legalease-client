...
import { DeferredAdminAnalyticsPage, DeferredAdminLawyersPage, DeferredAdminTransactionsPage, DeferredAdminUsersPage } from './DeferredAdminPages'
    ...
    children: [
      ...
      { path: '/register', element: <GuestOnlyRoute><RegisterPage /></GuestOnlyRoute> },
      {
        ...
        children: [
          ...
          { path: 'admin/manage-users', element: <RoleRoute roles={['admin']}><DeferredAdminUsersPage /></RoleRoute> },
          { path: 'admin/manage-lawyers', element: <RoleRoute roles={['admin']}><DeferredAdminLawyersPage /></RoleRoute> },
          { path: 'admin/all-transactions', element: <RoleRoute roles={['admin']}><DeferredAdminTransactionsPage /></RoleRoute> },
          { path: 'admin/analytics', element: <RoleRoute roles={['admin']}><DeferredAdminAnalyticsPage /></RoleRoute> },
        ],
      },
